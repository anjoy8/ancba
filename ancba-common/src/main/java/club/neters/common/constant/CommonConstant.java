...
public class CommonConstant {
    ...
    public static final String[] GW_SECURITY_WHITELIST = {"/", "/oauth/**", "/actuator/**", "/error", "/open/api", "/actuator/health", "/actuator", "/swagger-ui.html", "/swagger-resources/**", "/webjars/**", "/v2/**", "/error"};
}
